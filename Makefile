#############################################################################
# Makefile for building: zoptax-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Mar 26 08:23:40 2019
# Project:  zoptax-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile zoptax-qt.pro
#############################################################################
...
Makefile: zoptax-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile zoptax-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/zoptax/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/zoptax/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/zoptax/src/leveldb/libleveldb.a: FORCE
